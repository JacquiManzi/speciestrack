...
def get_gbif_data():
    ...
    # # Bounds from export.json: minlat=37.9187401, minlon=-122.3244358, maxlat=37.960035, maxlon=-122.261997
    # geometry = get_bounding_box_polygon(-122.3244358, 37.9187401, -122.261997, 37.960035)
    ...
    print(f"DEBUG - GBIF geometry: {geometry}")
